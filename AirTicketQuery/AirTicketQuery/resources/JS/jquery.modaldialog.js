...
(function($) {
    ...
    function showDialog(msg, options) {
        ...
        if (!document.getElementById('dialog')) {
            ...
            // Set the click event for "Close" buttons	
        ...
        if (settings.timeout) {
            window.setTimeout("$('#dialog').fadeOut('slow', 0); document.getElementById('dialog-mask').style.visibility = 'hidden';", (settings.timeout * 1000));
        }
    ...
    modaldialog.DialogTitles = {
        "error": "!! Error -- Please call IT support !!"
		, "warning": "Warning!"
		, "success": "Success"
